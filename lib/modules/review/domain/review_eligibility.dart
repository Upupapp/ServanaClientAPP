class ReviewEligibility {
  ...
  factory ReviewEligibility.fromMap(Map<String, dynamic> m) {
    ...
    return ReviewEligibility(
      ...
      reviewWindowOpensAt:  window != null ? DateTime.tryParse(window['opensAt'].toString()) : null,
      reviewWindowClosesAt: window != null ? DateTime.tryParse(window['closesAt'].toString()) : null,
      editableUntil:        m['editableUntil'] != null ? DateTime.tryParse(m['editableUntil'].toString()) : null,
      availableActions:     (m['availableActions'] as List?)?.cast<String>() ?? const [],
    );
  }
}
