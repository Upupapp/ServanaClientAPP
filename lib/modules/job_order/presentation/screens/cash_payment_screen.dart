...
import 'package:client/modules/job_order/presentation/widgets/cash_done_dialog.dart';

class CashPaymentScreen extends StatefulWidget {
  static String routeName = "CashPaymentScreen";
  static String route = "CashPaymentScreen";
                        ...
                        children: [
                          Row(
                            children: [
                              Flexible(
                                child: Text(
                                  "Please confirm the sum for payment in cash.",
                                  maxLines: 4,
                                  style: TextStyle(
                                    fontFamily: FontPalette.primaryFontFamily,
