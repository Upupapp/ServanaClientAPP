...
class ScreenAnalyticsObserver {
  ...
  static String? _canonicalScreenName(String path) {
    ...
    if (_matchesPattern(p, r'^/bookings/[^/]+/payment$')) return 'payment_webview';
    if (_matchesPattern(p, r'^/bookings/[^/]+/otp$')) return 'booking_otp';
    if (_matchesPattern(p, r'^/bookings/[^/]+/confirm$')) return 'booking_confirmation';
    ...
    if (_matchesPattern(p, r'^/support/tickets/[^/]+$')) return 'support_ticket_detail';
