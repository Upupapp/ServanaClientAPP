...
final class SupportOpenedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'support_opened';
...
final class SupportCategorySelectedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'support_category_selected';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
...
final class SupportTicketStartedEvent extends AnalyticsEvent {
  ...
  final String supportCategory;
  @override String get eventName => 'support_ticket_started';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
      {AnalyticsKeys.supportCategory: supportCategory};
}
...
final class SupportTicketSubmittedEvent extends AnalyticsEvent {
  ...
  final String supportCategory;
  @override String get eventName => 'support_ticket_submitted';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
      {AnalyticsKeys.supportCategory: supportCategory};
}
...
final class SupportTicketFailedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'support_ticket_failed';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {
        AnalyticsKeys.supportCategory: supportCategory,
...
final class SupportTicketOpenedEvent extends AnalyticsEvent {
  ...
  final String supportCategory;
  @override String get eventName => 'support_ticket_opened';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
      {AnalyticsKeys.supportCategory: supportCategory};
}
...
final class SupportReplySucceededEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'support_reply_succeeded';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
...
final class SupportTicketClosedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'support_ticket_closed';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
...
final class SupportTicketReopenedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'support_ticket_reopened';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
...
final class SafetyEntryOpenedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'safety_entry_opened';
  @override ConsentCategory get consentCategory => ConsentCategory.essential;
  @override Map<String, Object?> get properties => {};
}

final class SafetySubmissionAttemptedEvent extends AnalyticsEvent {
  const SafetySubmissionAttemptedEvent();
  @override String get eventName => 'safety_submission_attempted';
  @override ConsentCategory get consentCategory => ConsentCategory.essential;
  @override Map<String, Object?> get properties => {};
}
...
final class SafetySubmissionSucceededEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'safety_submission_succeeded';
  @override ConsentCategory get consentCategory => ConsentCategory.essential;
  @override String? get dedupKey => 'safety_submission_succeeded';
  @override Map<String, Object?> get properties => {};
}
