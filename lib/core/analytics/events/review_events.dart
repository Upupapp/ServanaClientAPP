...
final class ReviewPromptShownEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'review_prompt_shown';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override String? get dedupKey => 'review_prompt:$serviceCategory';
...
final class ReviewStartedEvent extends AnalyticsEvent {
  ...
  final String serviceCategory;
  @override String get eventName => 'review_started';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
      {AnalyticsKeys.serviceCategory: serviceCategory};
}
...
final class ReviewRatingSelectedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'review_rating_selected';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
...
final class ReviewSubmittedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'review_submitted';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override String? get dedupKey => 'review_submitted:$serviceCategory';
  @override Map<String, Object?> get properties => {
        AnalyticsKeys.ratingBucket: ratingBucket,
        AnalyticsKeys.serviceCategory: serviceCategory,
...
final class ReviewSubmissionFailedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'review_submission_failed';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
...
final class ReviewProviderResponseViewedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'review_provider_response_viewed';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
