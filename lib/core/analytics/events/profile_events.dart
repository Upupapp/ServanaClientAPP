...
final class ProfileOpenedEvent extends AnalyticsEvent {
  const ProfileOpenedEvent(
      {required this.completionBand});
  final String completionBand;
  @override String get eventName => 'profile_opened';
...
final class ProfileEditStartedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'profile_edit_started';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
...
final class ProfileUpdateSucceededEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'profile_update_succeeded';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
      {AnalyticsKeys.fieldCategory: fieldCategory};
}
...
final class ProfileUpdateFailedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'profile_update_failed';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {
        AnalyticsKeys.fieldCategory: fieldCategory,
...
final class ProfilePhotoStartedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'profile_photo_started';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
...
final class ProfilePhotoSucceededEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'profile_photo_succeeded';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
...
final class ContactVerificationStartedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'contact_verification_started';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
...
final class ContactVerificationSucceededEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'contact_verification_succeeded';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override String? get dedupKey => 'contact_verify:$verificationType';
  @override Map<String, Object?> get properties =>
      {AnalyticsKeys.verificationType: verificationType};
}
...
final class AddressCreatedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'address_created';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties =>
...
final class AddressSetPrimaryEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'address_set_primary';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
...
final class AddressDeletedEvent extends AnalyticsEvent {
  ...
  @override String get eventName => 'address_deleted';
  @override ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override Map<String, Object?> get properties => {};
}
