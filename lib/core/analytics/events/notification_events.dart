...
final class NotificationPermissionPromptShownEvent extends AnalyticsEvent {
  ...
  @override
  String get eventName => 'notification_permission_prompt_shown';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  String? get dedupKey => 'notif_perm_prompt';
  @override
...
final class NotificationPermissionGrantedEvent extends AnalyticsEvent {
  ...
  @override
  String get eventName => 'notification_permission_granted';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  String? get dedupKey => 'notif_perm_granted';
  @override
  Map<String, Object?> get properties => {};
}
...
final class NotificationPermissionDeniedEvent extends AnalyticsEvent {
  ...
  @override
  String get eventName => 'notification_permission_denied';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  String? get dedupKey => 'notif_perm_denied';
  @override
  Map<String, Object?> get properties => {};
}
...
final class NotificationReceivedForegroundEvent extends AnalyticsEvent {
  ...
  @override
  String get eventName => 'notification_received_foreground';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  Map<String, Object?> get properties =>
...
final class NotificationOpenedEvent extends AnalyticsEvent {
  const NotificationOpenedEvent(
      {required this.notificationType, required this.appState, this.routeKey});
  final String notificationType;
  final String appState; // 'foreground' | 'background' | 'terminated'
  final String? routeKey;
  @override
  String get eventName => 'notification_opened';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  Map<String, Object?> get properties => {
...
final class NotificationDeepLinkSucceededEvent extends AnalyticsEvent {
  ...
  final String routeKey;
  @override
  String get eventName => 'notification_deep_link_succeeded';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  Map<String, Object?> get properties => {AnalyticsKeys.routeKey: routeKey};
}
...
final class NotificationDeepLinkFailedEvent extends AnalyticsEvent {
  ...
  @override
  String get eventName => 'notification_deep_link_failed';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  Map<String, Object?> get properties => {
...
final class NotificationMarkedReadEvent extends AnalyticsEvent {
  ...
  final String notificationType;
  @override
  String get eventName => 'notification_marked_read';
  @override
  ConsentCategory get consentCategory => ConsentCategory.analytics;
  @override
  Map<String, Object?> get properties =>
